...
public class HeapBasedPriorityQueue<T extends Comparable<T>> implements PriorityQueue<T > {
	...
	void decreasePriority(T element, T newElement) {
		
	}

	void increasePriority(T element, T newElement) {
