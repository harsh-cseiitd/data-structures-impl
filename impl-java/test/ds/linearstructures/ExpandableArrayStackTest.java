...
public class ExpandableArrayStackTest {

	@Test
	public void testLifoOrder() {
		Stack<Integer> stack = new ExpandableArrayStack<Integer>();
		assert(stack.empty());
		stack.push(10);
		stack.push(20);
		stack.push(30);
	...
	public void testIterator () {
		ExpandableArrayStack<Integer> stack = new ExpandableArrayStack<Integer>();
